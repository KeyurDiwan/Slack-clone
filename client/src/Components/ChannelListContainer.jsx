...
const CompanyHeader = () => (
    <div className="channel-list__header">
        ...
        <p className="channel-list__header__text"> Slack clone </p>
    </div>
...
const ChannelListContainer = ({setCreateType, setIsCreating, setIsEditing}) => {
    ...
    return (
        <>
            ...
            <div className="channel-list__container-responsive"
                style={{
                    left: toggleContainer  ? "0%" : "-89%", backgroundColor:"red"
                }}
            >

                <div className=" -list__container-toggle" onClick = {() => setToggleContainer((prevToggleContainer) => !prevToggleContainer)} ></div>
                 <ChannelListContent
